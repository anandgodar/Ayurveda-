	...
	<div class="col-sm-12">
		<table
			...
			<tbody>
				...
				<tr role="row" class="odd" ng-repeat="diseaseRecord in diseaseRecords">
					...
					<td class="sorting_2 sorting_3"><a href ng-click="getPatientByDisease(diseaseRecord.disease)">{{diseaseRecord.diseaseCount}}</a></td>
		...
		<table
			...
			<thead>
				<tr role="row">
					<th class="sorting_disabled" rowspan="1" colspan="1"
						aria-label="Name" style="width: 219px;">First Name</th>
					<th class="sorting_disabled" rowspan="1" colspan="1"
						style="width: 200px;" aria-label="Position">Last Name</th>
					<th class="sorting_disabled" rowspan="1" colspan="1"
						style="width: 164px;" aria-label="Office">Email</th>
					<th class="sorting_disabled" rowspan="1" colspan="1"
						style="width: 68px;" aria-label="Extn">Gender</th>
						<th class="sorting_disabled" rowspan="1" colspan="1"
						style="width: 68px;" aria-label="Extn">Address</th>
