...
<html lang="en" class="no-js"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/favicon.ico">
        ...
        <ul class="nav navbar-nav navbar-left">
          ...
          <li class="dropdown navbar-notification empty">
            ...
            <div class="dropdown-menu">
              ...
              <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/page-notifications.html" class="notification-link">View All Alerts</a>
        ...
        <ul class="mainnav-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li>
                <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/form-plugins.html">
              ...
              <li>
                <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/components-datatables.html">
              ...
              <li>
                <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/components-charts.html">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li>
                <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/page-pricing-table.html">
              ...
              <li>
                <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/page-faq.html">
              ...
              <li>
                <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/pages-gallery.html">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li>
                <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/page-notifications.html">
              ...
              <li class="dropdown-submenu">
                <a tabindex="-1" href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/#">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/page-maintenance.html">
                    <i class="fa fa-cogs dropdown-icon "></i> 
                    Maintenance
                    </a>
                  </li> 
                  ...
                  <li>
                    <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/page-404.html">
                  ...
                  <li>
                    <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/page-500.html">
                    <i class="fa fa-ban dropdown-icon "></i> 
                    500 Error
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/page-blank.html">
              ...
              <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/account-login-social.html">
                    <i class="fa fa-unlock dropdown-icon "></i> 
                    Login Social
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/account-signup.html">
                  ...
                  <li>
                    <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/admin/account-forgot.html">
          ...
          <li class="dropdown is-open">
            ...
            <ul class="dropdown-menu" role="menu">
              <li>
                <a href="https://jumpstartthemes.com/demo/v/2.1.0/templates/landing/">
